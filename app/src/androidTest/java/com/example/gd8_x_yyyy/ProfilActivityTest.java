...
public class ProfilActivityTest {
    ...
    public void profilActivityTest() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.etFirstName),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText.perform(replaceText("Cyrillus"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.etLastName),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText2.perform(replaceText("Rama"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText4 = onView(
                allOf(withId(R.id.etLastName), withText("Rama"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.layout_lastname),
                                        0),
        ...
        ViewInteraction textInputEditText6 = onView(
                allOf(withId(R.id.etLastName),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText6.perform(replaceText("Rama"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText7 = onView(
                allOf(withId(R.id.etSemester),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText7.perform(replaceText("0"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText8 = onView(
                allOf(withId(R.id.etSemester), withText("0"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText8.perform(replaceText("10"));
        ...
        ViewInteraction textInputEditText10 = onView(
                allOf(withId(R.id.etSemester), withText("10"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText10.perform(replaceText("7"));
        ...
        ViewInteraction textInputEditText12 = onView(
                allOf(withId(R.id.etTanggalLahir),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText12.perform(replaceText("10"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText13 = onView(
                allOf(withId(R.id.etTanggalLahir), withText("10"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText13.perform(replaceText("1011009"));
        ...
        ViewInteraction textInputEditText15 = onView(
                allOf(withId(R.id.etTanggalLahir), withText("1011009"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText15.perform(replaceText("101100"));
